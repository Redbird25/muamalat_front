...
import {Empty, Pagination, Spinner} from "../../../components";
                    ...
                    !isFetched
                      ...
                      : isFetched && data.length
                        ? data.map((item, number) =>
                          <React.Fragment>
                            <tr
                              onClick={() => navigate(`/dashboard/orders/view/${get(item, "id")}`)}
                            ...
                            >
                              ...
                              <td
                                ...
                                className={"border-bottom-0 p-0"}>
                                <div
                                  className={"mb-2 border border-start-0 h-100 px-3 d-flex-column-center-center position-relative fs-12 fw-700 text-greyscale800 custom-rounded-end-12 text-center py-1"}
                                >
                                  <div
                                    style={{
                                      width: 1
                                  ...
                                  <div
                                    ...
                                    className={`${item === 0 ? "bg-34c759 text-white" : item === 1 ? "bg-3d82c4 text-white" : item === 3 ? "bg-ef5c2c text-white" : item === 4 ? "bg-f04e79 text-white" : "bg-transparent text-75758b fs-20 lh-20"} w-100 custom-rounded-8 text-nowrap d-flex-center-center  px-2`}>
                                    {
                                      item === 0
                                        ? "Доставлено"
                                        : item === 1
